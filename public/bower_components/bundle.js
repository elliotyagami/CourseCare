...
},{"@mitter-io/web":2}],2:[function(require,module,exports){
(function (global){
(function (global, factory) {
  ...
  ***************************************************************************** */
  ...
  var WebSocketPipelineDriver = /** @class */ (function () {
          ...
          return {
              ...
              initialized: new Promise(function (resolve, reject) {
                  mitter.getUserAuthorization().then(function (userAuthorization) {
                      _this.connectToStream(resolve, reject);
                  });
              })
          };
      };
      ...
      WebSocketPipelineDriver.prototype.connectToStream = function (resolveFn, rejectFn) {
          var _this = this;
          if (this.mitterContext === undefined) {
              if (rejectFn !== undefined) {
                  rejectFn(Error('Cannot connect to websocket, invalid mitter context (found undefined)'));
              }
              else {
                  console.warn('Cannot connect to websocket, invalid mitter context.' +
                      ' Also no error handlers were assigned to catch this error');
              }
          }
          else {
              this.mitterContext.getUserAuthorization().then(function (userAuthorization) {
                  var _a;
                  var sockJs = new entry(_this.mitterContext.mitterApiBaseUrl + "/v1/socket/control/sockjs");
                  _this.activeSocket = over(sockJs);
                  _this.activeSocket.debug = noOp$1;
                  var reject = noOp$1;
                  var resolve = noOp$1;
                  ...
                  if (userAuthorization === undefined || _this.activeSocket === undefined) {
                      ...
                      var authHeaders = (_a = {},
                          ...
                          _a);
                      if (_this.mitterContext.applicationId !== undefined) {
                          authHeaders[StandardHeaders.ApplicationIdHeader] = _this.mitterContext.applicationId;
                      }
                      ...
                      _this.activeSocket.connect(authHeaders, function (frame) {
                          ...
                          setTimeout(_this.connectToStream, 500);
                      });
                  }
              });
          }
...
},{"websocket":3}],3:[function(require,module,exports){
